...
CREATE TABLE user(user_id text PRIMARY KEY, password text, first_name text, last_name text, created timestamp);
...
INSERT INTO post_category(id, name, created) VALUES (4590408a-125b-11e6-a148-3e1d05defe78, 'Category-1', toTimestamp(now()));
INSERT INTO post_category(id, name, created) VALUES (607c47a4-125b-11e6-a148-3e1d05defe78, 'Category-2', toTimestamp(now()));
